...
export function ShaderBackground() {
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uNoise: { value: 0.2 },
      uOpacity: { value: 0.75 },
      // Vermelho escuro e mais sutil
      uColor: { value: new THREE.Color(0x3f0d0d) },
    }
    ...
    const fragmentShader = `
      ...
      varying vec2 vUv;
      uniform float uTime, uSpeed, uScale, uRot, uNoise, uOpacity;
      uniform vec3 uColor;
      ...
      void main(){
        ...
        // Amplitude mais baixa para um visual menos intenso
        float pat = 0.5 + 0.25 * sin(
