        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative bg-dark/50 backdrop-blur-sm rounded-2xl p-1 border border-primary/20">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-white/60 text-center p-8 rounded-xl">
                <div>
                  <FaDiscord className="text-6xl mb-4 mx-auto text-primary/50" />
                  <p className="text-lg mb-2">Junte-se ao nosso Discord!</p>
                  <p className="text-sm">Clique no botão acima para entrar</p>
                </div>
              </div>
              <iframe
                ...
                className="rounded-xl relative z-10 bg-transparent"
                onError={(e) => console.error('Discord widget error:', e)}
                onLoad={() => console.log('Discord widget loaded')}
              />
            </div>
          </motion.div>
        </div>
