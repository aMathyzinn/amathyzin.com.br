...
const InnovationsCube = dynamic(() => import('@/components/three/InnovationsCube'), { ssr: false })

// RotatingCube movido para '@/components/three/InnovationsCube'
  ...
  return (
    <section id="projects" className="section-padding bg-gradient-dark relative overflow-hidden">
      <div className="container-custom mx-auto">
        ...
        >
          {/* Temporarily placeholder to validate error source */}
          <div className="w-full h-full rounded-xl bg-dark/40 border border-primary/20" />
        </motion.div>
