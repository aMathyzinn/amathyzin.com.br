            ...
            <div className="relative bg-dark/50 backdrop-blur-sm rounded-2xl p-1 border border-primary/20">
              <iframe
                ...
                onError={(e) => {
                  ...
                  fallback.innerHTML = `
                    <div class="flex items-center justify-center h-full text-white/60 text-center p-8">
                      <div>
                        <div class="text-6xl mb-4 text-primary/50">💬</div>
                        <p class="text-lg mb-2">Widget do Discord indisponível</p>
                        <p class="text-sm">Use o botão "Entrar no Discord" acima</p>
                      </div>
                    </div>
                  `;
                ...
                onLoad={() => console.log('Discord widget loaded successfully')}
              />
            </div>
          </motion.div>
        </div>
