...
export function Navbar() {
  ...
  const navItems = [
    ...
    { href: 'https://github.com/amathyzin', label: 'GitHub', icon: FaGithub, external: true },
    { href: 'https://discord.gg/XBajMu5dcr', label: 'Comunidade', icon: FaDiscord, external: true },
    { href: 'https://www.youtube.com/@aMathyzin', label: 'Vídeos', icon: FaYoutube, external: true },
  ]
