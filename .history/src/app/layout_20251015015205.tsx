...
import { ParticleBackground } from '@/components/dynamic/DynamicComponents'
  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        <link rel="dns-prefetch" href="https://amathyzin.com.br" />
        ...
        <meta name="apple-mobile-web-app-title" content="Amathyzin" />
