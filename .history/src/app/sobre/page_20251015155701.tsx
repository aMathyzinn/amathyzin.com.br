        ...
        <div className="container-custom mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="https://discord.gg/XBajMu5dcr" target="_blank" rel="noopener noreferrer" className="btn-primary shine-effect">
                <FaDiscord />
                Discord
              </Link>
              <a href="https://www.youtube.com/@aMathyzin" target="_blank" rel="noopener noreferrer" className="btn-primary shine-effect">
                <FaYoutube />
                YouTube
              </a>
              <Link href="https://github.com/amathyzin" target="_blank" rel="noopener noreferrer" className="btn-primary shine-effect">
                <FaGithub />
                GitHub
              </Link>
            </div>
