      ...
      <div className="container-custom mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="card-gradient p-8 rounded-lg flex flex-col items-center">
            <Image src={product.imageUrl || `/img/${product.id}.png`} alt={product.title} width={192} height={192} className="object-contain mb-6" />
            ...
            <div className="card-gradient p-6 mt-6 rounded-lg">
              <h4 className="text-xl font-semibold text-gradient mb-3">⚠️ Arquivo Temporariamente Indisponível</h4>
              <p className="text-white/70 mb-4">
                O arquivo {product.fileName} está sendo atualizado. Por favor, tente novamente em breve ou entre em contato conosco.
              </p>
              <div className="flex gap-4">
                <a href="/discord" className="btn-secondary" target="_blank" rel="noopener noreferrer">
                  Suporte Discord
                </a>
                <a href="/youtube" className="btn-secondary" target="_blank" rel="noopener noreferrer">
                  Ver Tutorial
                </a>
              </div>
            </div>
            ...
            {product.id === 'robooster2' && (
              <div className="card-gradient p-6 mt-6 rounded-lg">
                ...
                <div className="flex gap-4">
                  <a href="https://bloxstrap.pizzaboxer.xyz/" className="btn-secondary" target="_blank" rel="noopener noreferrer">
                    BloxStrap
                  </a>
                  <a href="https://dotnet.microsoft.com/download" className="btn-secondary" target="_blank" rel="noopener noreferrer">
                    .NET Framework
                  </a>
                </div>
              </div>
