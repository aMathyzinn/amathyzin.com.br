            ...
            <div className="card-gradient rounded-2xl p-6 sticky top-24 border border-white/10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                {termsAccepted ? (
                  ...
                  <button 
                    disabled 
                    className="w-full py-3 px-6 rounded-xl font-medium bg-dark/30 text-white/40 border border-white/10 cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    <FaDownload /> Aceite os Termos para Baixar
                  </button>
                )}
