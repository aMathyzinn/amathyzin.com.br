            ...
            <div className="card-gradient rounded-2xl p-6 sticky top-24 border border-white/10 space-y-6">
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <LazyImage
                    src={product.imageUrl && product.imageUrl.trim() !== '' && !product.imageUrl.includes('amathyzin.com') ? product.imageUrl : 'https://amathyzin.com.br/imgs/logo.png'}
                    fallbackSrc="https://amathyzin.com.br/imgs/logo.png"
                    alt={product.title}
