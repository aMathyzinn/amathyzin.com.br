        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            <div className="card-gradient rounded-2xl p-6 sticky top-24 border border-white/10 space-y-6">
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  {(() => {
                    ...
                    const logoSrc = product.imageUrl && !product.imageUrl.includes('amathyzin.com')
                      ? product.imageUrl
                      : fallbackLogo
                    return (
                      <Image
              ...
              {/* Progress bar */}
              <div className="rounded-full bg-dark/40 overflow-hidden">
              ...
              <div className="space-y-3">
                ...
                <a href={`/downloads/files/${product.fileName}`} className="btn-primary w-full justify-center shine-effect group">
