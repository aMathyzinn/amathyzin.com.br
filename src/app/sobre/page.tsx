...
const timeline = [
  ...
  },
  {
    year: '2024',
    title: 'Expansão',
    description: 'Mais de 5K inscritos e 10K+ downloads dos nossos packs',
  },
]

const stats = [
  { icon: FaUsers, value: '5K+', label: 'Inscritos' },
  { icon: FaCode, value: '20+', label: 'Projetos' },
  { icon: FaTrophy, value: '10K+', label: 'Downloads' },
        ...
        <div className="container-custom mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link href="/youtube" className="btn-primary shine-effect">
                <FaYoutube />
                YouTube
              </Link>
