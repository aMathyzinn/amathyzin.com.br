...
const timeline = [
  { year: '2020', title: 'Início da Jornada', description: 'Começamos compartilhando dicas de otimização no YouTube' },
  { year: '2021', title: 'Primeiros Packs', description: 'Lançamento dos primeiros packs de otimização para Windows' },
  { year: '2022', title: 'Comunidade Discord', description: 'Criação do servidor Discord oficial com mais de 1000 membros' },
  { year: '2023', title: 'RoBooster', description: 'Desenvolvimento do RoBooster para otimização do Roblox' },
  { year: '2024', title: 'Expansão', description: 'Mais de 7.5K inscritos e 300K+ downloads dos nossos packs' },
]
