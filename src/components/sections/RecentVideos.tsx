...
export function RecentVideos() {
  ...
  return (
    <section id="videos" className="section-padding bg-darker/50">
      <div className="container-custom mx-auto">
        ...
        <div className="flex justify-end mb-6">
          <label className="flex items-center gap-2 cursor-pointer bg-dark/50 px-4 py-2 rounded-full">
            <input
              type="checkbox"
              checked={autoplay}
            ...
            />
            <span className="text-white/80 text-sm">Rolagem Automática</span>
          </label>
        </div>
